...
const Overview = ({ view }: prop) => {
  ...
  return (
    <div
      className="bg-lightTheme-cardBg dark:bg-darkTheme-cardBg rounded-sm p-6 flex flex-col gap-6 my-1
   cursor-pointer hover:bg-lightTheme-cardBgHv dark:hover:bg-darkTheme-cardBgHv "
    >
      <section className="flex items-center justify-between">
        <p className="text-lightTheme-text dark:text-darkTheme-text font-semibold">
          {view.name}
        </p>
        <Image src={view.icon} alt={view.name} width={20} height={20} />
      </section>
      <section className="flex items-center justify-between">
        <p className="text-lightTheme-darkText dark:text-darkTheme-whiteText text-4xl font-bold">
          {view.count}
        </p>
        <div className="flex items-center justify-center gap-1">
          ...
          <p
            className={`${
              isup ? "text-primary-lime" : "text-primary-red"
            } font-semibold`}
          >
            {view.change}
          </p>
